...
public class Ventana extends JPanel {
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
            	...
            	if (SwingUtilities.isLeftMouseButton(e)) {
                    ...
                    // Buscar el nodo más cercano al punto de clic en las coordenadas originales
    ...
    protected void paintComponent(Graphics g) {
        ...
        // Establecer el área de recorte (clipping) basada en la visibleArea
        ...
        // Dibujar solo los nodos y bordes dentro del área visible
     ...
     // Agregar un ComponentListener a tu panel
        addComponentListener(new ComponentAdapter() {
            @Override
            public void componentResized(ComponentEvent e) {
                // Actualizar visibleArea cuando se redimensiona la ventana
                actualizarAreaVisible();
            }
        });
 ...
 // Agregar un método para encontrar el nodo más cercano
    public Nodo encontrarNodoMasCercano(double mouseX, double mouseY) {
        ...
        for (Nodo nodo : nodos) {
            ...
            // Calcular la distancia entre el nodo y el clic del ratón sin aplicar zoom
